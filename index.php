...
<head>
	<title></title>
	<?php include 'https://coronavirus.github.io/link/links.php';?>
	<?php include 'https://coronavirus.github.io/css/style.php';?>
</head>
<body onload="fetch()">
...
<nav class="navbar navbar-expand-lg navbar-light nav_style p-3 ">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto pr-5 text-capitalize">
      ...
      <li class="nav-item">
        <a class="nav-link" href="https://coronavirus.github.io/coronaupdate.php">WorldCoronaLive</a>
      </li>
      <li class="nav-item">
